    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Column(
              children: [
                Center(child: Text('Hola Xd', style: TextStyle(
                  fontSize: 25,color: Colors.blueGrey[50]),
                )),
                Center(child: Text('Actividad ${widget.actividad}', style: TextStyle(
                  fontSize: 25,color: Colors.blueGrey[50]),)),
                Center(child: Text('Tiempo de concentracion ${widget.tConcentracion}', style: TextStyle(
                  fontSize: 25,color: Colors.blueGrey[50]),)),
                Center(child: Text('Tiempo de descanso ${widget.tDescanso}', style: TextStyle(
                  fontSize: 25,color: Colors.blueGrey[50]),)),
              ],
          ),
        ],
